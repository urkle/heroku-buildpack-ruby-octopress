...
This is a [Heroku buildpack](http://devcenter.heroku.com/articles/buildpacks) for Octopress, Jekyll, Ruby, Rack, and Rails apps. It uses [Bundler](http://gembundler.com) for dependency management.
